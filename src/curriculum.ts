...
export function buildFactoringQueue(level: 1 | 2 | 3 | 4 | 5 | "review"): Pair[] {
  if (level === "review") {
    return shuffle([
      ...buildFactoringQueue(1).slice(0, 5),
      ...buildFactoringQueue(2).slice(0, 5),
      ...buildFactoringQueue(3).slice(0, 5),
      ...buildFactoringQueue(5).slice(0, 5),
    ]);
  }
